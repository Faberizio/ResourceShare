...
api_urlpatterns = [
    ...
    path("api/v1/categories", api_views.list_categories, name="list_categories"),
    path("api/v2/resource/", api_views.ListResources.as_view(), name="list-resources-class"),
    path("api/v2/resource/<int:id>", api_views.ListResources.as_view(), name="detail-resource-class"),
    path(
