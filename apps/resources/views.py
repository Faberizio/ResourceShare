...
def resource_detail(request, id):
    ...
    # Check if data exist already and remove it
    if viewed_resource in viewed_resources:
        viewed_resources.remove(viewed_resources)
...
def resource_post(request):
    ...
    # User made a POST request
        ...
        if form.is_valid():
            ...
            # Manually add the user id (assuming user authentication is set up)
